...
public class USACODriver{
	...
	for (int i = 1; i < 11; i ++){
	    String file = "makelake." + i; // Remove the "makelake/" if the test files are in the same directory
	...
	for (int i = 1; i < 11; i ++){
	    String file = "ctravel." + i; // Remove the "ctravel/" if the test files are in the same directory
	    int ans = getAnswer(file + ".out");
